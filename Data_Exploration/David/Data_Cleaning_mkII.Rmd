...
temp_nsw <- read.csv(unz('../../data/H03-2021/temperature_nsw.csv.zip', 'temperature_nsw.csv'), header = T)
dem_nsw <- read.csv(unz('../../data/H03-2021/totaldemand_nsw.csv.zip', 'totaldemand_nsw.csv'), header = T)
...
write.csv(cleaned_temp_dem_df, "Cleaned_Data_mkII.csv", row.names = FALSE)
```
